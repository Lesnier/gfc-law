...
?>
<?php
//si no se recibe el formulario y no hay Empresa para eliminar, no puede seguir vuelve a la lista.
if (!isset ($_POST['submit']) && (empty($_GET['IdEmpresa']))){
...
<center>
<BR>
<H1>Menu Principal de <B> Empresas </B> [ELIMINAR]</H1><br>
<BR>
...
if (isset ($_POST['submit']) ) {
	...
	$res = mysql_query ($sql) ; //or die (mysql_error () ) ;
		...
		if (mysql_errno() !=0 ) {
			$message  = "<BR>Asegurese de eliminar todos los poveedores antes de eliminar la empresa " ;
			$message .= "\n<BR><!--" ;
			...
			echo "La empresa ". $_POST['IdEmpresa'] ." ha sido eliminada";
...
<tr>
<td><input name="IdEmpresa" type="hidden" id="IdEmpresa" value="<?php echo $IdEmpresa;?>">
<br>
¿Seguro de querer borrar 
La empresa <?php echo $IdEmpresa;?>?</td>
</tr>
...
<tr>
<td align="center"><a href = "empr_listado.php"><img border="0" alt="volver" src="images/volver.gif"/></a></td>
</tr>
