...
//   Valida para el pais CS CtaCorrienteNro solo si CtaCorrienteMarca es SI
	}elseif(($_POST ['CtaCorrienteMarca'] == "SI") and ($_POST ['CtaCorrienteNro'] == "") OR 
			($_POST ['CtaCorrienteMarca'] != "SI") and ($_POST ['CtaCorrienteNro'] != "")) {
		$message = "Debe ingresar Cuenta Corriente solo si esta permitido";
	}
	return $message;
}
...
//		$sql .= "Identificacion = '" . $_POST ['Identificacion'] . "' , ";
		...
		$sql .= "CuotaSindical = '" . $_POST ['CuotaSindical'] . "' , ";
		$sql .= "SeguroDesempleo = '" . $_POST ['SeguroDesempleo'] . "' , ";
		$sql .= "LibretaTrabajo = '" . $_POST ['LibretaTrabajo'] . "' , ";
		$sql .= "Obra = '" . $_POST ['Obra'] . "' , ";
		$sql .= "CtaCorrienteMarca = '" . $_POST ['CtaCorrienteMarca'] . "' , ";
		$sql .= "CtaCorrienteNro = '" . $_POST ['CtaCorrienteNro'] . "'   ";
...
//	$Identificacion = $_POST ['Identificacion'] ;
	...
	$CuotaSindical = comboSiNo($_POST ['CuotaSindical'] ) ;
	$SeguroDesempleo = comboSiNo($_POST ['SeguroDesempleo'] ) ;
	$LibretaTrabajo = comboSiNo($_POST ['LibretaTrabajo'] ) ;
	$Obra = $_POST ['Obra'] ;
	$CtaCorrienteMarca = comboSiNo($_POST ['CtaCorrienteMarca'] ) ;
	$CtaCorrienteNro = $_POST ['CtaCorrienteNro'] ;
}else{
	//nos conectamos a mysql
	$cnx = conectar();
...
//		$Identificacion = $fila['Identificacion'] ;
		...
		$CuotaSindical = comboSiNo($fila ['CuotaSindical'] ) ;
		$SeguroDesempleo = comboSiNo($fila ['SeguroDesempleo'] ) ;
		$LibretaTrabajo = comboSiNo($fila ['LibretaTrabajo'] ) ;
		$Obra = $fila ['Obra'] ;
		$CtaCorrienteMarca = comboSiNo($fila ['CtaCorrienteMarca'] ) ;
		$CtaCorrienteNro = $fila ['CtaCorrienteNro'] ;
	}
}
?> 
<?php
...
<tr>
<td width="200">Cuota Sindical</td>
<td width="300"><select name="CuotaSindical"><?php echo $CuotaSindical ; ?></select></td>
</tr>
<tr>
<td width="200">Seguro de Desempleo</td>
<td width="300"><select name="SeguroDesempleo"><?php echo $SeguroDesempleo ; ?></select></td>
</tr>
<tr>
<td width="200">Libreta de Trabajo</td>
<td width="300"><select name="LibretaTrabajo"><?php echo $LibretaTrabajo ; ?></select></td>
</tr>
<tr>
<td width="200">Obra</td>
<td width="300"><input name="Obra" type="text" id="Obra" value="<?php echo $Obra ; ?>"></td>
</tr>
<tr>
<td width="200">Cta.Corriente (SI/NO)</td>
<td width="300"><select name="CtaCorrienteMarca"><?php echo $CtaCorrienteMarca ; ?></select></td>
</tr>
<tr>
<td width="200">Cta.Corriente (CBU)</td>
<td width="300"><input name="CtaCorrienteNro" type="text" id="CtaCorrienteNro" value="<?php echo $CtaCorrienteNro ; ?>"></td>
</tr>
