...
<table width="500" cellpadding="0" cellspacing="0" 1>
    <tr>
    <td height="3O" COLSPAN="2" ALIGN="center"><H1>Ingreso de Empleados</H1></td>
    </tr>
...
?>
    ...
    <table width="500" cellpadding="4" cellspacing="1" border="1" >
        ...
        <tr>
        <td width="250" align="right">Cuota Sindical: </td>
        <td width="250"><?php echo $userArray['CuotaSindical'];?>&nbsp;</td>
        </tr>
        <tr>
        <td width="250" align="right">Seguro de Desempleo: </td>
        <td width="250"><?php echo $userArray['SeguroDesempleo'];?>&nbsp;</td>
        </tr>
        <tr>
        <td width="250" align="right">Libreta de Trabajo: </td>
        <td width="250"><?php echo $userArray['LibretaTrabajo'];?>&nbsp;</td>
        </tr>
        <tr>
        <td width="250" align="right">Obra: </td>
        <td width="250"><?php echo $userArray['Obra'];?>&nbsp;</td>
        </tr>
        <tr>
        <td width="250" align="right">Cta.Corriente(SI/NO): </td>
        <td width="250"><?php echo $userArray['CtaCorrienteMarca'];?>&nbsp;</td>
        </tr>
        <tr>
        <td width="250" align="right">Cta.Corriente(CBU): </td>
        <td width="250"><?php echo $userArray['CtaCorrienteNro'];?>&nbsp;</td>
        </tr>
