...
?>
<?php
//si no se recibe el formulario y no hay Empresa para editar, no puede seguir vuelve a la lista.
...
<center>
<BR>
<H1>Menu Principal de <B> Empresas </B> [EDITAR]</H1><br>
<BR>
...
if(isset ($_POST['submit'])) {
	...
	if($message != "") {
		...
		if (mysql_errno() !=0 ) {
			...
			echo "La empresa ". $_POST['Empresa'] ." ha sido editada";
...
if(isset ($_POST['submit'])) {
	...
	$sql  = "SELECT Empresa, Pais, Identificacion, Usuario, Clave, Logo " ;
	$sql .= "FROM empresas ";
...
//si hay resultados o ha habido errores, hacemos el formulario. Si es la primea vez y no hayd datos, no lo hace
?>
...
<tr>
<td width="200">*Empresa<input name="IdEmpresa" type="hidden" id="IdEmpresa" value="<?php echo $IdEmpresa;?>"></td>
