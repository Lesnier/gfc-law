...
//		$sql .= "Identificacion = '" . $_POST ['Identificacion'] . "' , ";
		...
		$sql .= "BPS = '" . $_POST ['BPS'] . "' , ";
		$sql .= "BPS_Ultimo_Pago = '" . $_POST ['BPS_Ultimo_Pago'] . "' , ";
		$sql .= "BSE_certificado = '" . $_POST ['BSE_certificado'] . "' , ";
		$sql .= "BSE_pago_periodo = '" . $_POST ['BSE_pago_periodo'] . "' , ";
		$sql .= "DGI = '" . $_POST ['DGI'] . "' , ";
		$sql .= "DGI_Ultimo_Pago = '" . $_POST ['DGI_Ultimo_Pago'] . "' , ";
		$sql .= "MTSS = '" . $_POST ['MTSS'] . "' , ";
...
//		$Identificacion = $fila['Identificacion'] ;
		$Condicion = comboCondicionUY($fila['Condicion']) ;
		$BPS = comboSiNo($fila ['BPS']) ;
		$BPS_Ultimo_Pago = comboSiNo($fila ['BPS_Ultimo_Pago']) ;
		$BSE_certificado = comboSiNo($fila ['BSE_certificado']) ;
		$BSE_pago_periodo = comboSiNo($fila['BSE_pago_periodo']) ;
		$DGI = comboSiNo($fila ['DGI']) ;
		$DGI_Ultimo_Pago = comboSiNo($fila ['DGI_Ultimo_Pago']) ;
		$MTSS = comboSiNoNc($fila ['MTSS']) ;
