...
if(isset ($_POST['submit'])) {
	...
	if($message != "") {
		...
		$campos  .= "CuotaSindical, SeguroDesempleo, LibretaTrabajo, Obra, CtaCorrienteMarca, CtaCorrienteNro " ;
		$valores  = "";
		...
		$valores .= "'" . $_POST ['CuotaSindical'] . "' , ";
		$valores .= "'" . $_POST ['SeguroDesempleo'] . "' , ";
		$valores .= "'" . $_POST ['LibretaTrabajo'] . "' , ";
		$valores .= "'" . $_POST ['Obra'] . "' , ";
		$valores .= "'" . $_POST ['CtaCorrienteMarca'] . "' , ";
		$valores .= "'" . $_POST ['CtaCorrienteNro'] . "'   ";

		$sql = "INSERT INTO empleadosCS (" . $campos . ") VALUES (" . $valores . ") ";
...
if(isset ($_POST['submit'])) {
	...
	$Responsable = '' ;
	$CuotaSindical = comboSiNo("SI") ;
	$SeguroDesempleo = comboSiNo("SI") ;
	$LibretaTrabajo = comboSiNo("SI") ;
	$Obra = '' ;
	$CtaCorrienteMarca = comboSiNo("SI") ;
	$CtaCorrienteNro = '' ;
}
?> 
